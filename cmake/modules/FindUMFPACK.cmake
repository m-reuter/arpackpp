...
if ( UMFPACK_FOUND )
  if ( NOT TARGET SuiteSparse::UMFPACK )
    add_library(SuiteSparse::UMFPACK INTERFACE IMPORTED GLOBAL)
    set_target_properties(SuiteSparse::UMFPACK PROPERTIES INTERFACE_LINK_LIBRARIES "${UMFPACK_LIBRARIES}")
  endif ( )
else ( )
