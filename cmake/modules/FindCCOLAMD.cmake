...
if ( CCOLAMD_FOUND )
  if ( NOT TARGET SuiteSparse::CCOLAMD )
    add_library(SuiteSparse::CCOLAMD INTERFACE IMPORTED GLOBAL)
    set_target_properties(SuiteSparse::CCOLAMD PROPERTIES INTERFACE_LINK_LIBRARIES "${CCOLAMD_LIBRARY}")
  endif ()
else ()
